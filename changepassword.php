    ...
    <body class="bg-gray-100 dark:bg-neutral-900 flex items-center justify-center h-screen">
        ...
        <!-- Header/Title: stretches to fill rest of row, stays on one line -->
        <h1 class="flex-1 min-w-0 ms-4 text-2xl font-semibold text-gray-900 dark:text-white whitespace-nowrap">
            Change Password
        </h1>
    </div>
    <!-- Center: Title -->
...
<p id="change-password-desc" class="text-left text-sm text-gray-600 dark:text-neutral-400" <?php if (!empty($success_message)) echo 'style="display:none"'; ?>>
    Your new password must contain at least one uppercase letter, one number, and one special character (&, !, or @).
</p>
...
<?php if (empty($success_message)): ?>
    <div class="mt-5">
        ...
        <form method="post" autocomplete="off">
          <div class="grid gap-y-4">
            ...
            <!-- Old Password Field -->
            <div class="max-w-sm">
              <label for="old_password" class="block text-sm mb-2 dark:text-white">Old Password</label>
              <div class="relative">
                <input type="password" id="old_password" name="old_password"
                class="py-2.5 sm:py-3 ps-4 pe-10 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
                placeholder="Enter old password" required>
                <button type="button"
                data-hs-toggle-password='{"target": "#old_password"}'
                ...
                tabindex="-1" aria-label="Toggle Old Password Visibility">
                <!-- Eye Icon SVG -->
    ...
    <!-- New Password Field WITH Toggle and Strength Popover -->
    <div class="max-w-sm">
      ...
      <div class="relative flex-1">
        ...
        id="new_password"
        name="new_password"
        class="py-2.5 sm:py-3 ps-4 pe-10 block w-full border-gray-200 rounded-md sm:text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
        ...
        >
        <button type="button"
        data-hs-toggle-password='{"target": "#new_password"}'
        class="absolute inset-y-0 end-0 flex items-center z-20 px-3 cursor-pointer text-gray-400 rounded-e-md focus:outline-hidden focus:text-blue-600 dark:text-neutral-600 dark:focus:text-blue-500"
    ...
    class="hidden absolute z-10 w-full bg-white shadow-md rounded-lg p-4 dark:bg-teal-800/30 dark:border dark:border-neutral-700">
...
<div class="max-w-sm">
  ...
  <div class="relative">
    ...
    class="py-2.5 sm:py-3 ps-4 pe-10 block w-full border-gray-200 rounded-md sm:text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400"
    placeholder="Re-enter new password" required>
    <button type="button"
    data-hs-toggle-password='{"target": "#confirm_password"}'
    class="absolute inset-y-0 end-0 flex items-center z-20 px-3 cursor-pointer text-gray-400 rounded-e-md focus:outline-hidden focus:text-blue-600 dark:text-neutral-600 dark:focus:text-blue-500"
...
class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50" disabled>
Change Password
</button>
</div>
</form>
